...
class ArrayQueueTest {
	...
	void testGetFront() {
		...
		assertEquals(Double.valueOf(0.0), doubleQueue.getFront());
		assertEquals(Double.valueOf(0.0), doubleQueue.dequeue());
		assertEquals(Double.valueOf(1.0), doubleQueue.getFront());
		assertEquals(Double.valueOf(1.0), doubleQueue.dequeue());
		assertEquals(Double.valueOf(2.0), doubleQueue.getFront());
		assertEquals(Double.valueOf(2.0), doubleQueue.dequeue());

		assertThrows(EmptyQueueException.class, () -> {
			doubleQueue.getFront();
		});
	}
