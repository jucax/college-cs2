...
class SortedLinkedListFromBaseTest {

	SortedLinkedListFromBase<Integer> intList;

	@BeforeEach
	void setUp() throws Exception {
		intList = new SortedLinkedListFromBase<Integer>();
		intList.add(100);
		intList.add(5);
		intList.add(0);
		intList.add(50);
	...
	@Test
	void testSortedLinkedListFromBase() {
		SortedLinkedListFromBase<Integer> temp = new SortedLinkedListFromBase<>();
