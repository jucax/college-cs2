...
class SortedArrayListFromArrayListTest {

	SortedArrayListFromArrayList<Integer> intList;

	@BeforeEach
	void setUp() throws Exception {
		intList = new SortedArrayListFromArrayList<Integer>();
		intList.add(100);
		intList.add(5);
		intList.add(0);
		intList.add(50);
	...
	@Test
	void testSortedArrayListFromArrayList() {
		SortedArrayListFromArrayList<Integer> temp = new SortedArrayListFromArrayList<>();
	...
	@Test
	void testRemoveT() {
		assertTrue(intList.remove(Integer.valueOf(100)));
		assertFalse(intList.remove(Integer.valueOf(101)));
		assertTrue(intList.remove(Integer.valueOf(5)));
		assertFalse(intList.remove(Integer.valueOf(-5)));
		assertTrue(intList.remove(Integer.valueOf(0)));
		assertFalse(intList.remove(Integer.valueOf(1)));
		assertTrue(intList.remove(Integer.valueOf(50)));
		assertFalse(intList.remove(Integer.valueOf(57)));
		assertTrue(intList.remove(Integer.valueOf(27)));
		assertFalse(intList.remove(Integer.valueOf(27)), "Error:"+Arrays.toString(intList.toArray()));
		assertTrue(intList.remove(Integer.valueOf(9000)));
		assertFalse(intList.remove(Integer.valueOf(10000)));
		assertTrue(intList.remove(Integer.valueOf(18)));
		assertFalse(intList.remove(Integer.valueOf(101)));
		assertFalse(intList.remove(Integer.valueOf(-3)));
	}
	...
	void testContains() {
		...
		assertFalse(intList.contains(49));
		assertTrue(intList.contains(50));
		assertFalse(intList.contains(60));
		assertTrue(intList.contains(100));
		assertFalse(intList.contains(3333));
		assertTrue(intList.contains(9000));
		assertFalse(intList.contains(9999));
